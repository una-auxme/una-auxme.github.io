...
Die Arbeit richtet sich an Studierende mit Interesse an maschinellem Lernen, der Programmiersprache [Julia](https://julialang.org/) (oder Python, da viele Parallelen existieren) und aktueller Forschung im Bereich Scientific Machine Learning (SciML).
