var store = [{
        ...
        "excerpt":"Language-coupled human 3D full-body motion generation has many applications in robotics, artificial intelligence, virtual reality and other domains. Existing methods, such as MotionGPT, are able to generate short sequences of human poses from text description, model interaction with other people and with the static environment, describe the observed motion with...","categories": [],
        "tags": ["ma"],
        "url": "/mandischer/motiongpt.html",
        "teaser": null
      },{
        "title": "Language-motion models for 3D human motion generation, captioning and prediction",
        "excerpt":"Language-coupled human 3D full-body motion generation has many applications in robotics, artificial intelligence, virtual reality and other domains. Existing methods, such as MotionGPT, are able to generate short sequences of human poses from text description, model interaction with other people and with the static environment, describe the observed motion with...","categories": [],
        "tags": ["ma"],
        "url": "/mandischer/motiongpt_en.html",
        "teaser": null
      },{
