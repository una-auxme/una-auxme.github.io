var store = [{
        ...
        "excerpt":"Ich befasse mich mit der Verbesserung von KI-gestützter Simulation von großen Partikelsystemen. Das Feld der Fluidsimulationen ist vielseitig und umfasst eine große Anzahl an Anwendungsfällen und Szenarien, die in Papern verwendet werden, um Methoden zu validieren und vergleichen. Etablierte Benchmarkprobleme, die überall Anwendung finden und verschiedene Komplexitätsebenen abbilden gibt es...","categories": [],
        "tags": ["fm","ba","hiwi"],
        "url": "/kircher/Datengenerierung.html",
        "teaser": null
      },{
        ...
        "excerpt":"Maßnahmen in der Rehabilitation werden in Form von Fähigkeitsprofilen dokumentiert, die den Therapieverlauf der Patienten wiedergeben. Ein verbreitetes Verfahren dazu ist IMBA (Integration von Menschen mit Behinderung in die Arbeitswelt). Wir vermuten, dass es innerhalb des Verfahrens versteckte Abhängigkeiten und Biases gibt. Daher soll in dieser Arbeit ein Datensatz von...","categories": [],
        "tags": ["pm","fm"],
        "url": "/mandischer/imba_data.html",
        "teaser": null
      },{
        "title": "HiWi für Mensch-Roboter-Kollaboration mit Menschen mit Behinderung",
        "excerpt":"In meiner Forschung beschäftige ich mich mit der Vorhersage von menschlichen Fähigkeiten, um damit Robotervrhaltne zu planen und insbesondere Menschen mit Behinderung in ihrem Arbeitsalltag zu unterstützen. Dabei werden Arbeitsmedizin und datengetriebene Methoden kombiniert. Ziel ist, dass eines Tages Personen egal welcher körperlichen Fähigkeiten und Voraussetzungen gemeinsam am Arbeitsalltag teilhaben...","categories": [],
        "tags": ["hiwi"],
        "url": "/mandischer/hiwi_capabilities.html",
        "teaser": null
      },{
