var store = [{
        "title": "Empirical evaluation of training methods for Balanced Neural ODEs",
        ...
        "excerpt":"Am Lehrstuhl für Mechatronik beschäftigen wir uns regelmäßig mit Optimal-Control-Problemen, insbesondere im Kontext modellprädiktiver Regelung (MPC). Für die Umsetzung solcher Algorithmen ist die Programmiersprache Julia besonders interessant. Es existieren bereits mehrere Pakete und Workflows zur Lösung von Optimal-Control-Problemen, z. B.: OptimalControl.jl ModelPredictiveControl.jl NLOptControl.jl … Ziel der Arbeit ist es, einen systematischen...","categories": [],
        "tags": ["pm","fm","sa","sb","ba"],
        "url": "/hoepfner/mpc_de.html",
        "teaser": null
      },{
        "title": "Comparison of Optimal Control Toolchains in Julia",
        "excerpt":"Topic for Student Thesis: Comparison of Optimal Control Toolchains in Julia At the Chair of Mechatronics, we regularly deal with optimal control problems, especially in the context of model predictive control (MPC). For implementing such algorithms, the Julia programming language is of particular interest. Several packages and workflows for solving...","categories": [],
        "tags": ["pm","fm","sa","sb","ba"],
        "url": "/hoepfner/mpc_en.html",
        "teaser": null
      },{
        ...
        "title": "Klassifikation von Griffvariaten für Roboterhände",
        "excerpt":"Am Lehrstuhl für Mechatronik untersuchen wir Mensch-Roboter Interaktion in verschiedenen Anwendungsfällen. Dabei werden Roboterbewegungen per Learning from Demonstration (d.h. durch Nachahmung des Menschen durch den Roboter) angelernt. Einen zunehmend wichtigen Faktor spielen dabei für den Menschen ausgelegte Prozesse, sei es das Schraubeneindrehen in der Arbeitswelt oder Lebensmittel einräumen im Haushalt....","categories": [],
        "tags": ["pm","ba","ma"],
        "url": "/mandischer/grip_detection.html",
        "teaser": null
      },{
        "title": "Reharobotik für Armfunktionstraining nach Schlaganfall",
        "excerpt":"Gemeinsam mit dem Therapiezentrum Burgau wollen wir zeitnah mit der Entwicklung eines Reharoboters starten, der zur teilautomatisierten Therapie im Armfunktionstraining nach Schlaganfall eingesetzt werden soll. Der Roboter verstärkt und führt dabei die Bewegung der Patientinnen und Patienten mit Armparese (min. halbseitige Lähmung der oberen Extremitäten) und entlastet dadurch die Therapeutinnen...","categories": [],
        "tags": ["ma"],
